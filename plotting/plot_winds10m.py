...
def main():
    ...
    dset = utils.read_dataset(variables=['wind_speed_of_gust', 'air_pressure_at_sea_level', 'x_wind_10m', 'y_wind_10m'],
                              projection=projection)

    dset['wind_speed_of_gust'] = dset['wind_speed_of_gust'].metpy.convert_units(
...
def plot_files(dss, **args):
    ...
    for time_sel in dss.time:
        ...
        cs = args['ax'].contourf(args['x'], args['y'], data['wind_speed_of_gust'],
