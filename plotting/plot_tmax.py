...
def main():
    ...
    dset = utils.read_dataset(variables=['air_temperature_max'], projection=projection)
    dset['air_temperature_max'] = dset['air_temperature_max'].metpy.convert_units('degC').metpy.dequantify()
